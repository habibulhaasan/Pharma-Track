...
import { ElementRef, ComponentPropsWithoutRef, HTMLAttributes } from "react";
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "duration-150 data-[state=open]:animate-slide-in",
        className
      )}
      {...props}
    >
...
const DialogHeader = ({ className, ...props }: HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 p-5 pb-3 flex-shrink-0", className)} {...props} />
);
...
const DialogFooter = ({ className, ...props }: HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-0 sm:space-x-2 p-5 pt-3 border-t flex-shrink-0",
      className
    )}
    {...props}
  />
